    ...
    $.googlePlaces = function(element, options) {
        ...
        var renderReviews = function(reviews){
          ...
          for (var i = row_count; i >= 0; i--) {
            ...
            html = html+"<div class='review-item'><div class='review-meta'><span class='review-author'>"+name+'  '+reviews[i].icon +"<span class='review-date'>"+date+"</span></div>"+stars+"<p class='review-text'>"+reviews[i].text+"</p></div>"
          };
          $element.append(html);
        }
